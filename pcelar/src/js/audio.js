...
import audioFastSimpleChop from "../audio/fastSimpleChop.mp3";
import audioCartoonJump from "../audio/audioCartoonJump.mp3";
...
import srem from "../audio/srem.mp3";
import audioGameTeleport from "../audio/gameTeleport.mp3";
...
export const audio = {
  ...
  fastSimpleChop: new Howl({
    src: [audioFastSimpleChop],
    volume: 0.4,
  }),
  cartoonJump: new Howl({
    src: [audioCartoonJump],
    volume: 0.4,
  }),
